...
// Render all html data in html page 
...
export const updateWeather = function (lat, lon) {
    ...
    fetchData(url.currentWeather(lat, lon), function (currentWeather) {
        ...
        // })
        fetchData(url.reverseGeo(lat, lon), function (responseData) {
            const [{ name, country }] = responseData;
            card.querySelector("[data-location]").innerHTML = `${name}, ${country}`;
        });
        ...
        */
                ...
                timezone)}</p>
                        ...
                        <div class="card-item">
                            ...
                            <div>
                                ...
                                <p class="title-1">${module.getTime(sunsetUnixUTC,
                    timezone)}</p>
                            </div>
                        </div>
                    </div>
        ...
        fetchData(url.forecast(lat, lon), function (forecast) {
            ...
            for (const [index, data] of forecastList.entries()) {
                ...
                <img src="./assets/images/weather_icons/direction.png" width="48" height="48"
                    loading="lazy" alt="direction" class="weather-icon" 
                   style="transform: rotate(${windDirection - 180}deg)" title="">
        ...
        for (let i = 7, len = forecastList.length; i < len; i += 8) {
            ...
            <div class="icon-wrapper">
                <img src="./assets/images/weather_icons/${icon}.png" 
                  height="36" width="36" alt="${description}"
